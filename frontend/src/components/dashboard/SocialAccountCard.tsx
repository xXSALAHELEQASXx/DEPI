...
const SocialAccountCard = ({
  ...
  const platformColors = {
    ...
    twitter: "from-blue-400 to-sky-300",
  ...
  return (
    <Card className="overflow-hidden">
      <div className={`bg-gradient-to-r ${platformColors[platform]} px-6 pt-6 pb-4`}>
        <div className="flex justify-between text-white mb-3">
          <div className="flex items-center space-x-2">
            {platformIcons[platform]}
            <span className="text-lg font-bold">{platform.charAt(0).toUpperCase() + platform.slice(1)}</span>
          </div>
